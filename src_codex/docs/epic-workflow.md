...
- [ ] Operational deliverables executed where the epic includes them
- [ ] Real environment value-path validated (not just synthetic tests)
...
9. Document deployment considerations:
   ...
   - Data migrations
   - Deployment risks
   - Rollout / backfill / bootstrap steps actually executed
   - Evidence that the live target state changed as intended
...
- [ ] Operational rollout status documented
- [ ] Documentation update decisions surfaced explicitly
